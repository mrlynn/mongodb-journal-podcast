...
export default ({ show, setCurrentPlaying }) =>
  <div className="showNotes">
    ...
    <a className="button" href={`https://github.com/mrlynn/mongodb-journal-podcast/edit/master/${show.notesFile}`} target='_blank'><span className="icon">✏️</span> Edit Show Notes</a>
